...
<div class="weui_cells_title">请设置服务器相关参数</div>
<div class="weui_cells weui_cells_form">
    <div class="weui_cell">
        <div class="weui_cell_hd">
            <div class="weui_label">服务器当前IP</div>
        </div>
        <div class="weui_cell_hd">
            <div class="weui_label">192.168.1.127</div>
        </div>
    </div>
    <div class="weui_cell">
        <div class="weui_cell_hd">
            <div class="weui_label">修改服务器IP</div>
        </div>
...
<div class="weui_dialog_alert" id="dialog" style="display: none;">
    ...
    <div class="weui_dialog">
        ...
        <div class="weui_dialog_bd">参数修改成功</div>
