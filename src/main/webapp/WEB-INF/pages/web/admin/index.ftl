  ...
  <!--<![endif]-->
    ...
    <div class="navbar navbar-default" role="navigation">
        <div class="navbar-header">
          ...
          <a class="" href="index.ftl"><span class="navbar-brand"><span class="fa fa-paper-plane"></span>MIPS后台管理系统</span></a></div>
    ...
    <li><ul class="dashboard-menu nav nav-list collapse in">
            <li><a href="index.ftl"><span class="fa fa-caret-right"></span> Main</a></li>
